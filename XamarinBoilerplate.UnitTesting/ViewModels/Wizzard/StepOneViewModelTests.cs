...
{
    [TestClass]
    public class StepOneViewModelTests
    {
        XamarinBoilerplate.ViewModels.Wizzard.StepOneViewModel viewModel;
        ...
        {
            //arrange
            viewModel = new XamarinBoilerplate.ViewModels.Wizzard.StepOneViewModel();
